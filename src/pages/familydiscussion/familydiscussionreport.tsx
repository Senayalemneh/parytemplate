...
import { getFamilyDiscussion } from "../../services/api/main";
import {
  IconFilter,
  IconFilterOff,
  IconSearch,
...
const FamilyDiscussionReportPage = () => {
  ...
  const applyFilters = async (
    ...
    try {
      ...
      if (useRawQuery && rawQuery.trim() !== "") {
        // Parse raw query string into params object
        const searchParams = new URLSearchParams(rawQuery.trim());
      ...
      const response = await getFamilyDiscussion({ params });
      ...
      setIsFiltered(Object.keys(params).length > 2 || searchTerm !== "");
      showNotification(
  ...
  const resetFilters = () => {
    ...
    setCurrentPage(1);
    showNotification(
      t("familydiscussionn.report.notifications.resetSuccess"),
      "success"
    );
    applyFilters(1, perPage || 20);
  };
      ...
      <Card withBorder shadow="sm" radius="md" mb="xl" p="md">
        <Group mb="md">
          <input
            type="checkbox"
            checked={useRawQuery}
            onChange={() => setUseRawQuery((v) => !v)}
            id="useRawQuery"
            style={{ marginRight: 8 }}
          />
          <label htmlFor="useRawQuery">
            {t("familydiscussionn.report.useRawQuery") ||
        ...
        {useRawQuery ? (
          <TextInput
            label={
              t("familydiscussionn.report.rawQueryLabel") || "Raw Query String"
            }
            placeholder="from=2023-01-01&to=2023-12-31&district=North"
            value={rawQuery}
          ...
          <>
            ...
            <Grid gutter="md" mt="md">
              ...
              <Grid.Col span={12} md={6} lg={3}>
                <DateInput
                  label={t(
                    "familydiscussionn.report.filterLabels.recordedDate"
                  )}
                  placeholder={t(
              ...
              <Grid.Col span={12} md={6} lg={3}>
                <DateInput
                  label={t(
                    "familydiscussionn.report.filterLabels.conductedDate"
                  )}
                  placeholder={t(
                    "familydiscussionn.report.filterLabels.datePlaceholder"
                  )}
            ...
            <Grid gutter="md" mt="md">
              ...
              <Grid.Col span={12} md={6} lg={3}>
                <DateInput
                  label={t(
                    "familydiscussionn.report.filterLabels.conductedToDate"
                  )}
                  placeholder={t(
                    "familydiscussionn.report.filterLabels.datePlaceholder"
                  )}
            ...
            <Grid gutter="md" mt="md">
              ...
              <Grid.Col span={12} md={6} lg={3}>
                <NumberInput
                  label={t(
                    "familydiscussionn.report.filterLabels.minAttendance"
                  )}
                  placeholder={t(
            ...
            <Grid gutter="md" mt="md" justify="flex-end">
              <Grid.Col span={12} md={6} lg={3}>
                <Group position="right" spacing="md" mt={28}>
                  <Button
                    ...
                    color="gray"
                  >
                    {t("familydiscussionn.report.buttons.clearFilters")}
                  </Button>
                  <Button
