...
import { getorgStructureDistrict } from "../../services/api/main";
import {
  IconChevronDown,
  IconPointFilled,
  IconInfoCircle,
...
const OrganizationalChart = () => {
  ...
  const { data, isLoading, isFetching, error } = useQuery({
    queryKey: ["orgStructurefederal"],
    queryFn: getorgStructureDistrict,
    staleTime: 1000 * 60 * 5,
  });
    ...
    <Box className={classes.container}>
      ...
      >
        <Text className={classes.bannerText}>
          {t("federalorgstruct.banner_title_district")}
        </Text>
      </motion.div>
